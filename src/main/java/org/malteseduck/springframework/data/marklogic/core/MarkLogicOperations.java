...
public interface MarkLogicOperations {
    ...
    /**
     * Write the specified list of entities to the database.  Using the {@link org.malteseduck.springframework.data.marklogic.core.mapping.Document}
     ...
     * or the query is a {@link org.malteseduck.springframework.data.marklogic.repository.query.CombinedQueryDefinition} that includes
