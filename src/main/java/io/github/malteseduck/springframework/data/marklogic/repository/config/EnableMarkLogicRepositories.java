 ...
 */
package io.github.malteseduck.springframework.data.marklogic.repository.config;
...
public @interface EnableMarkLogicRepositories {
    ...
    /**
     * Configures the name of the {@link MarkLogicTemplate} bean to be used options the repositories detected.
     *
     * @return
     */
