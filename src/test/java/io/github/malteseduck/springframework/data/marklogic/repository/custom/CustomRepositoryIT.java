...
import io.github.malteseduck.springframework.data.marklogic.repository.config.EnableMarkLogicRepositories;
...
public class CustomRepositoryIT {
    ...
    public void shouldExecuteMethodOnCustomRepositoryImplementation() {
        ...
        Assertions.assertThat(people).containsExactly(bobby, george, jane);
